...
#define GREX_NEGATE_f GREX_NEGATE_FP
#define GREX_NEGATE_i GREX_NEGATE_INT
#define GREX_NEGATE_u GREX_NEGATE_INT
#define GREX_NEGATE(KIND, BITS, SIZE, BITPREFIX, REGISTERBITS) \
  inline Vector<KIND##BITS, SIZE> negate(Vector<KIND##BITS, SIZE> v) { \
    return {.r = GREX_APPLY(GREX_NEGATE_##KIND, KIND, BITS, SIZE, BITPREFIX, REGISTERBITS, \
