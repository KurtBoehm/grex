...
#define GREX_VTYPE_16(BASE, KIND, BITS, SIZE) Sub##BASE<KIND##BITS, SIZE>
#define GREX_VTYPE_32(BASE, KIND, BITS, SIZE) Sub##BASE<KIND##BITS, SIZE>
#define GREX_VTYPE_64(BASE, KIND, BITS, SIZE) Sub##BASE<KIND##BITS, SIZE>
#define GREX_VTYPE_128(BASE, KIND, BITS, SIZE) Native##BASE<KIND##BITS, SIZE>
#if GREX_X86_64_LEVEL >= 3
#define GREX_VTYPE_256(BASE, KIND, BITS, SIZE) Native##BASE<KIND##BITS, SIZE>
#else
#define GREX_VTYPE_256(BASE, KIND, BITS, SIZE) BASE##For<KIND##BITS, SIZE>
#endif
#if GREX_X86_64_LEVEL >= 4
#define GREX_VTYPE_512(BASE, KIND, BITS, SIZE) Native##BASE<KIND##BITS, SIZE>
#else
