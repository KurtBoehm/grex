...
// The value-type suffix used by scalar `_mm_cvts<letter>_<suffix>` intrinsics, e.g.
// `_mm_cvtss_f32`, `_mm_cvtsd_f64`, `_mm_cvtsh_h` (binary16 is the odd one out: `h`, not `f16`).
#define GREX_CVTS_VALSUFFIX_16 h
#define GREX_CVTS_VALSUFFIX_32 f32
#define GREX_CVTS_VALSUFFIX_64 f64
#define GREX_CVTS_VALSUFFIX(BITS) GREX_CVTS_VALSUFFIX_##BITS
...
#define GREX_SIR_SUFFIX_I(KIND, BITS, REGISTERBITS) \
  GREX_SI_SUFFIX_##KIND(BITS, REGISTERBITS, GREX_CAT(GREX_FP_SUFFIX(BITS), REGISTERBITS))
#define GREX_SIR_SUFFIX(...) GREX_SIR_SUFFIX_I(__VA_ARGS__)
...
#define GREX_BITPREFIX_I(REGISTERBITS) GREX_BITPREFIX_##REGISTERBITS
#define GREX_BITPREFIX(REGISTERBITS) GREX_BITPREFIX_I(REGISTERBITS)
...
#define GREX_KINDCAST_I(SRCKIND, DSTKIND, BITS, REGISTERBITS, X) \
  GREX_KINDCAST_##SRCKIND##DSTKIND(X, SRCKIND, BITS, DSTKIND, BITS, REGISTERBITS)
#define GREX_KINDCAST(...) GREX_KINDCAST_I(__VA_ARGS__)
