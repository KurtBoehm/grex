...
#define GREX_KINDCAST_IMPL(X, SRCKIND, DSTKIND, BITS, REGISTERBITS) \
  GREX_CAT(GREX_BITPREFIX(REGISTERBITS), _cast, GREX_SI_SUFFIX(SRCKIND, BITS, REGISTERBITS), _, \
           GREX_SI_SUFFIX(DSTKIND, BITS, REGISTERBITS)) \
  (X)
#define GREX_KINDCAST_ff(X, ...) X
...
#define GREX_KINDCAST(SRCKIND, DSTKIND, BITS, REGISTERBITS, X) \
  GREX_KINDCAST_##SRCKIND##DSTKIND(X, SRCKIND, DSTKIND, BITS, REGISTERBITS)
