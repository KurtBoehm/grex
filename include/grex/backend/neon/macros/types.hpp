...
#define GREX_MEMTYPE_f(BITS) float##BITS##_t
#define GREX_MEMTYPE_i(BITS) i##BITS
#define GREX_MEMTYPE_u(BITS) u##BITS
#define GREX_MEMTYPE(KIND, BITS) GREX_MEMTYPE_##KIND(BITS)
