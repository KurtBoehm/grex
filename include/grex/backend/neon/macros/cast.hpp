...
#define GREX_KINDCAST_ff(BITS, X) X
...
#define GREX_KINDCAST_I(DSTKIND, SRCKIND, BITS, X) GREX_KINDCAST_##DSTKIND##SRCKIND(BITS, X)
#define GREX_KINDCAST(DSTKIND, SRCKIND, BITS, X) GREX_KINDCAST_I(DSTKIND, SRCKIND, BITS, X)
