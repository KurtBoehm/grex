...
#define GREX_REPEAT_I(SIZE, MACRO, ...) GREX_REPEAT_##SIZE(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__)
#define GREX_REPEAT(SIZE, MACRO, ...) GREX_REPEAT_I(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__)

#define GREX_NREPEAT_0(...)
#define GREX_NREPEAT_1(SIZE, MACRO, ...) MACRO(SIZE, 0 __VA_OPT__(, ) __VA_ARGS__)
#define GREX_NREPEAT_2(SIZE, MACRO, ...) \
  GREX_NREPEAT_1(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__) \
  MACRO(SIZE, 1 __VA_OPT__(, ) __VA_ARGS__)
#define GREX_NREPEAT_3(SIZE, MACRO, ...) \
  GREX_NREPEAT_2(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__) \
  MACRO(SIZE, 2 __VA_OPT__(, ) __VA_ARGS__)
#define GREX_NREPEAT_4(SIZE, MACRO, ...) \
  GREX_NREPEAT_3(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__) \
  MACRO(SIZE, 3 __VA_OPT__(, ) __VA_ARGS__)
#define GREX_NREPEAT_I(SIZE, MACRO, ...) GREX_NREPEAT_##SIZE(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__)
#define GREX_NREPEAT(SIZE, MACRO, ...) GREX_NREPEAT_I(SIZE, MACRO __VA_OPT__(, ) __VA_ARGS__)
