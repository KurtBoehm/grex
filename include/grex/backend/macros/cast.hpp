...
#define GREX_OPCAST_f(KIND, BITS, X) X
...
#define GREX_RETCAST_f(BITS, X) X
#define GREX_RETCAST_i(BITS, X) GREX_OPCAST_i##BITS(i, BITS, X)
#define GREX_RETCAST_u(BITS, X) u##BITS(X)
#define GREX_RETCAST(KIND, BITS, X) GREX_RETCAST_##KIND(BITS, X)
