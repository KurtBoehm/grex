...
#define GREX_FOREACH_FP_TYPE_EXT(MACRO, REGISTERBITS, ...) \
  MACRO(f, 16, GREX_DIVIDE(REGISTERBITS, 16) __VA_OPT__(, ) __VA_ARGS__) \
  GREX_FOREACH_FP_TYPE(MACRO, REGISTERBITS __VA_OPT__(, ) __VA_ARGS__)

#if GREX_F16_NATIVE_ARITHMETIC
#define GREX_FOREACH_FP_TYPE_OPT_EXT GREX_FOREACH_FP_TYPE_EXT
#else
#define GREX_FOREACH_FP_TYPE_OPT_EXT GREX_FOREACH_FP_TYPE
#endif
...
#define GREX_FOREACH_TYPE_EXT(MACRO, REGISTERBITS, ...) \
  GREX_FOREACH_FP_TYPE_EXT(MACRO, REGISTERBITS __VA_OPT__(, ) __VA_ARGS__) \
  GREX_FOREACH_INT_TYPE(MACRO, REGISTERBITS __VA_OPT__(, ) __VA_ARGS__)

#if GREX_F16_NATIVE_ARITHMETIC
#define GREX_FOREACH_TYPE_OPT_EXT GREX_FOREACH_TYPE_EXT
#else
#define GREX_FOREACH_TYPE_OPT_EXT GREX_FOREACH_TYPE
#endif
...
#define GREX_FOREACH_SUB_EXT(MACRO, ...) \
  GREX_FOREACH_SUB(MACRO __VA_OPT__(, ) __VA_ARGS__) \
  MACRO(f, 16, 4, 8 __VA_OPT__(, ) __VA_ARGS__) \
  MACRO(f, 16, 2, 8 __VA_OPT__(, ) __VA_ARGS__)

#if GREX_F16_NATIVE_ARITHMETIC
#define GREX_FOREACH_SUB_OPT_EXT GREX_FOREACH_SUB_EXT
#else
#define GREX_FOREACH_SUB_OPT_EXT GREX_FOREACH_SUB
#endif
